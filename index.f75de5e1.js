...
document.addEventListener("click", (e)=>{
    ...
    newLeft = Math.max(wallReact.left, Math.min(newLeft, wallReact.right - spiderReact.width));
    newTop = Math.max(wallReact.top, Math.min(newTop, wallReact.bottom - spiderReact.height));
